...
public class SearchPage {
    ...
    public static final By continuarComprando = By.cssSelector("#layer_cart > div.clearfix > div.layer_cart_cart.col-xs-12.col-md-6 > div.button-container > a");
    public void addAoCarrinho() {
        BaseTest.click(addToCart);
    }

    public void setContinuarComprando() {
        BaseTest.click(continuarComprando);
    }
}
